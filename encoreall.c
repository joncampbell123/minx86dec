...
/* this alternate version for instructions like MOVSX where the destination is larger than source (a=reg, b=mem) */
static inline minx86_write_ptr_t minx86enc_32_overrides_movsx(struct minx86dec_argv *a,struct minx86dec_argv *b,struct minx86enc_state *est,minx86_write_ptr_t o,unsigned int wordsize) {
	if (b->regtype == MX86_RT_NONE && (b->memregsz>>2)^(est->addr32?1:0)) *o++ = 0x67;
	if (wordsize && ((a->size>>2)^(est->data32?1:0))) *o++ = 0x66;
	return o;
}
...
void minx86enc_encodeall(struct minx86enc_state *est,struct minx86dec_instruction *ins) {
	...
	switch (ins->opcode) {
		...
		case MXOP_CMPXCHG: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			unsigned char word = (a->size >= 2) ? 1 : 0;
			unsigned char opc = (ins->altopcode ? 0xA6/*486 Step A-B0*/ : 0xB0/*486 Step B1 to present day*/);
			...
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG) {
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = opc + word; o = minx86enc_encode_memreg(a,o,b->reg);
			}
			/* TEST reg,reg or TEST reg,reg */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = opc + word; o = minx86enc_encode_rm_reg(b,b->reg,a->reg,o);
			}
		} break;
		case MXOP_CMPXCHG8B: {
			struct minx86dec_argv *a=&ins->argv[0];
		...
		case MXOP_CLGI: {
			*o++ = 0x0F; *o++ = 0x01; *o++ = 0xDD;
		} break;
		case MXOP_STGI: {
			*o++ = 0x0F; *o++ = 0x01; *o++ = 0xDC;
		} break;
		case MXOP_CLI: {
			*o++ = 0xFA;
		} break;
		...
		case MXOP_XADD: {
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0x0F; *o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(b,b->reg,a->reg,o);
			}
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG) {
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0x0F; *o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_BSF: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
		...
		case MXOP_LZCNT: {
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xBD; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(b,est,o,1);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xBD; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_POPCNT: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xB8; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(b,est,o,1);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xB8; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_BSR: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
...
/* END FIXME */
		...
		case MXOP_ROL: { /*=====================ROL========================*/
			...
			/* ROL <reg>,CL */
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,0,a->reg,o);
			}
			/* ROL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,0,a->reg,o);
			}
			/* ROL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,0,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* ROL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,0);
			}
			/* ROL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,0);
			}
			/* ROL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,0);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_ROR: { /*=====================ROR========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,1,a->reg,o);
			}
			/* ROL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,1,a->reg,o);
			}
			/* ROL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,1,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* ROL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,1);
			}
			/* ROL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,1);
			}
			/* ROL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,1);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_RCL: { /*=====================RCL========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,2,a->reg,o);
			}
			/* RCL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,2,a->reg,o);
			}
			/* RCL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,2,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* RCL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,2);
			}
			/* RCL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,2);
			}
			/* RCL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,2);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_RCR: { /*=====================RCR========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,3,a->reg,o);
			}
			/* RCL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,3,a->reg,o);
			}
			/* RCL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,3,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* RCL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,3);
			}
			/* RCL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,3);
			}
			/* RCL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,3);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_SHL: { /*=====================SHL========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,4,a->reg,o);
			}
			/* RCL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,4,a->reg,o);
			}
			/* RCL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,4,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* RCL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,4);
			}
			/* RCL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,4);
			}
			/* RCL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,4);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_SHR: { /*=====================SHR========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,5,a->reg,o);
			}
			/* RCL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,5,a->reg,o);
			}
			/* RCL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,5,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* RCL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,5);
			}
			/* RCL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,5);
			}
			/* RCL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,5);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_SAR: { /*=====================SAR========================*/
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_rm_reg(a,7,a->reg,o);
			}
			/* RCL <reg>,1 */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_rm_reg(a,7,a->reg,o);
			}
			/* RCL <reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_rm_reg(a,7,a->reg,o);
				*o++ = (unsigned char)(b->value);
			}
			/* RCL <mem>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && b->size == 1 && b->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD2 + word; o = minx86enc_encode_memreg(a,o,7);
			}
			/* RCL <mem>,1 */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM && b->value == 1) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xD0 + word; o = minx86enc_encode_memreg(a,o,7);
			}
			/* RCL <mem>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0xC0 + word; o = minx86enc_encode_memreg(a,o,7);
				*o++ = (unsigned char)(b->value);
			}
		} break;
		case MXOP_CVTDQ2PS: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF8+(b->size==32?4:0);
					*o++ = 0x5B; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF8+(b->size==32?4:0);
					*o++ = 0x5B; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTDQ2PD: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xFA+(a->size==32?4:0);
					*o++ = 0xE6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xFA+(a->size==32?4:0);
					*o++ = 0xE6; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPD2DQ: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPD2PS: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x5A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x5A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPD2PI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPI2PD: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_MMX) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPI2PS: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_MMX) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPS2DQ: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPS2PD: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTPS2PI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSD2SI: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(b->size==32?4:0);
					*o++ = 0x2D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(b->size==32?4:0);
					*o++ = 0x2D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSD2SS: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSI2SD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF3+(b->size==32?4:0);
					*o++ = 0x2A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF3+(b->size==32?4:0);
					*o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSI2SS: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSS2SD: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5A; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTSS2SI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTPD2DQ: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0xE6; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTPD2PI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTPS2DQ: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5B; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTPS2PI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTSD2SI: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(b->size==32?4:0);
					*o++ = 0x2C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(b->size==32?4:0);
					*o++ = 0x2C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_CVTTSS2SI: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x2C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_DPPD: {
			...
			if (ins->argc == 4) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE && d->regtype == MX86_RT_IMM) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC4; *o++ = 0xE3; *o++ = 0x41+((b->reg^7)<<3)+(a->size==32?4:0);
					*o++ = 0x41; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
					*o++ = (unsigned char)(d->value);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE && d->regtype == MX86_RT_IMM) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC4; *o++ = 0xE3; *o++ = 0x41+((b->reg^7)<<3)+(a->size==32?4:0);
					*o++ = 0x41; o = minx86enc_encode_memreg(c,o,a->reg);
					*o++ = (unsigned char)(d->value);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x41; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
					*o++ = (unsigned char)(c->value);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x41; o = minx86enc_encode_memreg(b,o,a->reg);
					*o++ = (unsigned char)(c->value);
				}
			}
		} break;
		case MXOP_DPPS: {
			...
			if (ins->argc == 4) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE && d->regtype == MX86_RT_IMM) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC4; *o++ = 0xE3; *o++ = 0x41+((b->reg^7)<<3)+(a->size==32?4:0);
					*o++ = 0x40; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
					*o++ = (unsigned char)(d->value);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE && d->regtype == MX86_RT_IMM) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC4; *o++ = 0xE3; *o++ = 0x41+((b->reg^7)<<3)+(a->size==32?4:0);
					*o++ = 0x40; o = minx86enc_encode_memreg(c,o,a->reg);
					*o++ = (unsigned char)(d->value);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x40; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
					*o++ = (unsigned char)(c->value);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x40; o = minx86enc_encode_memreg(b,o,a->reg);
					*o++ = (unsigned char)(c->value);
				}
			}
		} break;
		...
		case MXOP_FIMUL: {
			...
			if (a->regtype == MX86_RT_NONE) {
				...
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = (a->size >= 4 ? 0xDA : 0xDE); o = minx86enc_encode_memreg(a,o,1);
			}
		} break;
		case MXOP_FRSTOR: {
			struct minx86dec_argv *a=&ins->argv[0];
			if (a->regtype == MX86_RT_NONE) {
				...
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0xDD; o = minx86enc_encode_memreg(a,o,4);
			}
		} break;
		case MXOP_FSAVE: {
			struct minx86dec_argv *a=&ins->argv[0];
			if (a->regtype == MX86_RT_NONE) {
				...
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0xDD; o = minx86enc_encode_memreg(a,o,6);
			}
		} break;
		case MXOP_FSTSW: {
			struct minx86dec_argv *a=&ins->argv[0];
			if (a->regtype == MX86_RT_NONE) {
				...
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0xDD; o = minx86enc_encode_memreg(a,o,7);
			}
			else if (a->regtype == MX86_RT_REG) {
				/* NTS: The decoder puts st(0) in the first argv for explanatory reasons, else
				 *      you would be wondering what FADD is adding to */
				if (ins->fwait) *o++ = 0x9B;
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0xDF; o = minx86enc_encode_rm_reg(a,4/*INC*/,a->reg,o);
			}
		} break;
		case MXOP_FISUB: {
			struct minx86dec_argv *a=&ins->argv[0];
		...
		case MXOP_FXRSTOR: {
			...
			if (a->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xAE; o = minx86enc_encode_memreg(a,o,1);
			}
		} break;
		case MXOP_FXSAVE: {
			struct minx86dec_argv *a=&ins->argv[0];
			if (a->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xAE; o = minx86enc_encode_memreg(a,o,0);
			}
		} break;
		case MXOP_INSERTPS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1],*c=&ins->argv[2];
			if (ins->argc == 4) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x21; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
					*o++ = (unsigned char)(c->value);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE && c->regtype == MX86_RT_IMM) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x3A; *o++ = 0x21; o = minx86enc_encode_memreg(b,o,a->reg);
					*o++ = (unsigned char)(c->value);
				}
			}
		} break;
		case MXOP_HADDPD: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3); *o++ = 0x7C; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3); *o++ = 0x7C; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_HADDPS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3); *o++ = 0x7C; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3); *o++ = 0x7C; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x7C; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x7C; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_HSUBPD: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3); *o++ = 0x7D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3); *o++ = 0x7D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_HSUBPS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3); *o++ = 0x7D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3); *o++ = 0x7D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x7D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x7D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_LDDQU: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(a->size==32?4:0); *o++ = 0xF0; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0xF0; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_BROADCASTSS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xC4; *o++ = 0xE2; *o++ = 0x79+(a->size==32?4:0); *o++ = 0x18; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_BROADCASTSD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && a->size == 32 && b->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xC4; *o++ = 0xE2; *o++ = 0x7D; *o++ = 0x19; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_BROADCASTF128: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && a->size == 32 && b->regtype == MX86_RT_NONE) {
				o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xC4; *o++ = 0xE2; *o++ = 0x7D; *o++ = 0x1A; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_MOVAPD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x28; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x28; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(a->size==32?4:0);
					*o++ = 0x29; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x28; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x28; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x29; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
		} break;
		case MXOP_MOVAPS: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x28; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x28; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x29; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
		} break;
		case MXOP_MASKMOVDQU: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0xF7; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MASKMOVQ: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_MMX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xF7; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MAXPD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MAXPS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC0+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC0+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MAXSD: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MAXSS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC2+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC2+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5F; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MINPD: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC1+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MINPS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC0+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC0+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MINSD: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC3+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MINSS: {
			...
			if (ins->argc == 3) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC2+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(c,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(c,est,o,0);
					*o++ = 0xC5; *o++ = 0xC2+((b->reg^7)<<3)+(b->size==32?4:0); *o++ = 0x5D; o = minx86enc_encode_memreg(c,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x5D; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MOVBE: { /*====================MOV=====================*/
		...
		case MXOP_MOVD: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x6E; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(a->size==32?4:0);
					*o++ = 0x7E; o = minx86enc_encode_rm_reg(b,b->reg,a->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(a->size==32?4:0);
					*o++ = 0x6E; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x7E; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x6E; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x6E; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_rm_reg(b,b->reg,a->reg,o);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_memreg(a,o,b->reg);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_REG) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x6E; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x6E; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_MMX) {
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_rm_reg(b,b->reg,a->reg,o);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_MMX) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
		} break;
		case MXOP_MOVDDUP: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(a->size==32?4:0);
					*o++ = 0x12; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xFB+(a->size==32?4:0);
					*o++ = 0x12; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x12; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF2; *o++ = 0x0F; *o++ = 0x12; o = minx86enc_encode_memreg(b,o,a->reg);
				}
			}
		} break;
		case MXOP_MOVDQA: {
			...
			if (ins->vex.raw != 0) {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(a->size==32?4:0);
					*o++ = 0x6F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(a->size==32?4:0);
					*o++ = 0x6F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xF9+(b->size==32?4:0);
					*o++ = 0x7F; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0x66; *o++ = 0x0F; *o++ = 0x7F; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
		} break;
		case MXOP_MOVDQU: {
			...
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
				else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
					o = minx86enc_seg_overrides(b,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_memreg(b,o,a->reg);
				}
				else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_seg_overrides(a,est,o,ins->segment >= 0);
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x7F; o = minx86enc_encode_memreg(a,o,b->reg);
				}
			}
		} break;
		case MXOP_MOVDQ2Q: {
			...
			if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xF2; *o++ = 0x0F; *o++ = 0xD6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MOVQ2DQ: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_MMX) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0xD6; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MOVHLPS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (ins->vex.raw != 0) {
				...
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE && c->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(a,est,o,0);
					*o++ = 0xC5; *o++ = 0xC0+(a->size==32?4:0)+((b->reg^7)<<3);
					*o++ = 0x12; o = minx86enc_encode_rm_reg(a,a->reg,c->reg,o);
				}
			}
			else {
				if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
					o = minx86enc_32_overrides(b,est,o,0);
					*o++ = 0x0F; *o++ = 0x12; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
				}
			}
		} break;
		case MXOP_MOVLHPS: {
			...
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x0F; *o++ = 0x16; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MOVHPD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0x16; o = minx86enc_encode_memreg(b,o,a->reg);
			}
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0x17; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVHPS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x0F; *o++ = 0x16; o = minx86enc_encode_memreg(b,o,a->reg);
			}
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0x17; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVMSKPD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0x50; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MOVMSKPS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x0F; *o++ = 0x50; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
		} break;
		case MXOP_MOVNTDQA: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0x38; *o++ = 0x2A; o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_MOVNTDQ: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0xE7; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVNTI: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xC3; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVNTPD: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0x2B; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVNTPS: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0x2B; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVNTQ: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_MMX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xE7; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVQ: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_MMX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_MMX && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0x0F; *o++ = 0x6F; o = minx86enc_encode_memreg(b,o,a->reg);
			}
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_MMX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0x7F; o = minx86enc_encode_memreg(a,o,b->reg);
			}
			else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_SSE && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides(b,est,o,0);
				*o++ = 0xF3; *o++ = 0x0F; *o++ = 0x7E; o = minx86enc_encode_memreg(b,o,a->reg);
			}
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_SSE) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x66; *o++ = 0x0F; *o++ = 0xD6; o = minx86enc_encode_memreg(a,o,b->reg);
			}
		} break;
		case MXOP_MOVSX: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0x0F; *o++ = 0xBE + (b->size>=2?1:0); o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides_movsx(a,b,est,o,1);
				*o++ = 0x0F; *o++ = 0xBE + (b->size>=2?1:0); o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_MOVZX: {
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1];
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG) {
				o = minx86enc_32_overrides(a,est,o,1);
				*o++ = 0x0F; *o++ = 0xB6 + (b->size>=2?1:0); o = minx86enc_encode_rm_reg(a,a->reg,b->reg,o);
			}
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_NONE) {
				o = minx86enc_32_overrides_movsx(a,b,est,o,1);
				*o++ = 0x0F; *o++ = 0xB6 + (b->size>=2?1:0); o = minx86enc_encode_memreg(b,o,a->reg);
			}
		} break;
		case MXOP_SHLD: { /*=====================SHLD========================*/
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1],*c=&ins->argv[2];
			...
			/* SHLD <reg>,<reg>,CL */
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && c->size == 1 && c->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xA5; o = minx86enc_encode_rm_reg(a,b->reg,a->reg,o);
			}
			/* SHLD <reg>,<reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && c->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xA4; o = minx86enc_encode_rm_reg(a,b->reg,a->reg,o); *o++ = c->value;
			}
			/* SHLD <mem>,<reg>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && c->size == 1 && c->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xA5; o = minx86enc_encode_memreg(a,o,b->reg);
			}
			/* SHLD <mem>,<reg>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && c->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xA4; o = minx86enc_encode_memreg(a,o,b->reg); *o++ = c->value;
			}
		} break;
		case MXOP_SHRD: { /*=====================SHRD========================*/
			struct minx86dec_argv *a=&ins->argv[0],*b=&ins->argv[1],*c=&ins->argv[2];
			...
			if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && c->size == 1 && c->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xAD; o = minx86enc_encode_rm_reg(a,b->reg,a->reg,o);
			}
			/* SHLD <reg>,<reg>,<imm> */
			else if (a->regtype == MX86_RT_REG && b->regtype == MX86_RT_REG && c->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xAC; o = minx86enc_encode_rm_reg(a,b->reg,a->reg,o); *o++ = c->value;
			}
			/* SHLD <mem>,<reg>,CL */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && c->size == 1 && c->reg == MX86_REG_CX) {
				o = minx86enc_32_overrides(a,est,o,0);
				*o++ = 0x0F; *o++ = 0xAD; o = minx86enc_encode_memreg(a,o,b->reg);
			}
			/* SHLD <mem>,<reg>,<imm> */
			else if (a->regtype == MX86_RT_NONE && b->regtype == MX86_RT_REG && c->regtype == MX86_RT_IMM) {
				o = minx86enc_32_overrides(a,est,o,word);
				*o++ = 0x0F; *o++ = 0xAC; o = minx86enc_encode_memreg(a,o,b->reg); *o++ = c->value;
			}
		} break;
	}
